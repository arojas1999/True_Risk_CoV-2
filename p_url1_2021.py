...
def get_csv(date_user1):
    ...
    gh1 = gh.replace('2021', '2021.csv')
    mock = 'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports_us/01-01-2021.csv'
    mock1 = mock.replace('01-01-2021.csv', gh1)
    url = mock1
    s = requests.get(url)
